...
const App = () => {
  return (
    <Router>
       <Route path="/user/:userId/edit" component={Header} />
          <Route path="/userList" component={Header} />
          <Route path="/profile" component={Header} />
          <Route path="/attendance" component={Header} />
          <Route path="/analysis" component={Header} />
          <Route path="/addStudent" component={Header} />
          <Route path="/student/edit/:id" component={Header} exact />
          <Route path="/student/:id" component={Header} exact />
          <Route path="/login" component={HeaderHome} exact />
          <Route path="/register" component={HeaderHome} exact />
          <Route path="/search/:keyword" component={Header} exact />
          <Route path="/page/:pageNumber" component={Header} exact />
          <Route
